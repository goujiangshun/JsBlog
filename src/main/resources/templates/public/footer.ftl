        ...
        <div class="row">
            <div class="col-lg-6 text-center text-lg-left my-auto">
                <ul class="list-inline mb-2 text-white">
                    ...
                    <li class="list-inline-item">&sdot;</li>
                    <li class="list-inline-item">
                        <a href="https://github.com/" target="_blank" class="text-white">Github 地址</a>
                    </li>
                </ul>
                <p class="text-muted small mb-4 mb-lg-0">&copy; GJS 2019 All Rights Reserved. </p>
                <p class="text-muted small mb-4 mb-lg-0">渝 ICP 备 XXXXXX 号</p>
            </div>
            <div class="col-lg-6 text-center text-lg-right my-auto">
                <ul class="list-inline mb-0">
                <#-- github -->
                    <li class="list-inline-item mr-3">
                        <a href="https://github.com/goujiangshun" target="_blank" class="text-white">
                            <i class="fa fa-github fa-2x fa-fw"></i>
                        </a>
                    </li>
                <#-- qq -->
                    <li class="list-inline-item mr-3">
                        <a href="tencent://message/?uin=1164869474&Site=在线QQ&amp;Menu=yes" class="text-white">
                            <i class="fa fa-qq fa-2x fa-fw"></i>
                        </a>
                    </li>
                <#-- wechat -->
                    <img id="id_img_wechat_qrcode" src="/img/gjs.png" alt="Wechat" class="img_shadow"
